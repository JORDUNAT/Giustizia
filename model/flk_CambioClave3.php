...
if($clavecontar<5 AND $clavecontar>9)
{
	...
	if($nueclave==$confclave){
		...
		if($resultado>0){
			echo '<div class="alert alert-success" role="alert"><span class="glyphicon glyphicon-floppy-ok"></span> Has cambiado tu clave con exito, ahora puedes ingresar. <br>
			...
			echo "<META HTTP-EQUIV='refresh' CONTENT='3; URL=../vistas/flk_CambioClave3.php'>";
