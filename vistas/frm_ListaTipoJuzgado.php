<?php	
	...
	$data = $obj_model -> getTipoJuzgadoRelacion($conexion);
...
$(document).ready(function(){
	...
	<article class="col-xs-12  col-sm-8 col-md-9 col-lg-9">
		<div class="ibody1 col-xs-12  col-sm-12 col-md-12 col-lg-12">
			...
			<h8 align='center'><b>TIPOS DE JUZGADOS</b></h8>
			</div>
			<div >
				<form name="flk_TipoJuzgado" id="flk_TipoJuzgado" method="POST" action="flk_TipoJuzgado.php">
					<div class="row">	
						...
						<div class="panel panel-default">
							...
							<table id="tbl_TipoJuzgado" class="table table-striped">
								...
								<tbody class="tablacontenido" align='center' style="color:#456789; font-size:85%">
							            <?php
											...
											{
												print "<tr>";
												print "<th align='center'> ".$tipousuario['tipjuz_Id']."</th>";
												print "<th>".$tipousuario['tipjuz_TipoJuzgado']."</th>";
												echo '<td align="center">';
												echo '<input type="radio" name="tipjuzg" id="tipjuzg" value="'.$tipousuario['tipjuz_Id'].'" required>';
										        echo "</td>";												
												print "</tr>";					
											}
										?>
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-danger" id="myModalLabel"><b>Estas Creando un Tipo de Juzgado</b></h4>
      </div>
      <div class="modal-footer" align="center">
				<form name="frm_crear" id="frm_crear" method="POST" action="">
					<div class="row" align="center">	
							...
							<input type="text" name="descripcion" id="descripcion"  class="form-control" placeholder="Tipo de Juzgado" required/>
							</div>
						...
						<div class="col-xs-12  col-sm-12 col-md-12 col-lg-12">
							<input type="submit" name="btn_CrearTipJuzg" id="btn_CrearTipJuzg" class="btn btn-primary" value="Guardar" >
