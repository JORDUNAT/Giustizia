<?php	
	...
	$data = $obj_model -> getClientes($conexion);
	$undata = $obj_model-> getUnCliente($conexion);
...
$(document).ready(function () {
	...
	<article class="col-xs-12  col-sm-8 col-md-9 col-lg-9">
		<div class="ibody1 col-xs-12  col-sm-12 col-md-12 col-lg-12">
			...
			<h8 align='center'><b>CONTROL DE CLIENTES</b></h8>
			</div>
			<div >
								...
								<tbody class="tablacontenido" align='center'>
										...
										if ($tipousuario=='1' || $tipousuario=='5'){
											foreach ($data as $usuario)
											{
										        ...
										        echo '<td align="center"><button class="btn btn-default" type="button" aria-hidden="true" onclick="'."location.href='flk_Clientes.php?Documento=".$usuario['usu_Documento'].";'".'">'."
											...
											foreach ($undata as $usuario)
											{
										        ...
										        echo '<td align="center"><button class="btn btn-default" type="button" aria-hidden="true" onclick="'."location.href='flk_ClientesU.php?Documento=".$usuario['usu_Documento'].";'".'">'."
														<span class='glyphicon  glyphicon-pencil'></span>
													</button></td>";
												print "</tr>";					
											}
